...
const Library = () => {
  ...
  return (
    <div
      className="w-full h-[100%] bg-gray-800 rounded-3xl overflow-y-auto"
      style={{
    ...
    >
      <div className="w-[96%] h-[90%] p-[3%] flex flex-wrap p-[3%] space-x justify-between">
        {playlist?.map((playlist) => (
          <div
            className="relative w-[17%] h-[45%] rounded-3xl bg-[#1e2a3e] border border-gray-600 p-3 mb-12 bg-gradient-to-br from-[#283754] to-gray-700 transform hover:scale-105 ease-in-out duration-300 "
            key={playlist.id}
          ...
          >
            ...
            <p className="font-normal text-[#c4d0e37c]">
